            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (cachedSchema && lastChangedAt <= cachedSchema.mtime) {
                        return [2 /*return*/, cachedSchema.schema];
                    }
...
function loader(source) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var done, validationErrors, options, document, output, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    this.cacheable();
                ...
                case 3:
                    ...
                    output = JSON.stringify(options.output === "document" ? document : printer_1.print(document));
